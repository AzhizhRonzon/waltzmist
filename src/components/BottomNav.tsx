...
const BottomNav = () => {
  ...
  const { nudgesReceived, crushesReceived } = useWaltzStore();
  ...
  const NAV_ITEMS = [
    ...
    { path: "/whispers", icon: MessageCircle, label: "Whispers", badge: unseenNudges },
        ...
        {NAV_ITEMS.map((item) => {
          ...
          return (
            <button
              ...
              className="relative flex flex-col items-center gap-0.5 py-2 px-3 rounded-2xl transition-colors"
            >
              {isActive && (
                <motion.div
                  layoutId="nav-active"
              ...
              <div className="relative">
                ...
                {item.badge > 0 && (
                  <span
                    className="absolute -top-1.5 -right-2 w-4 h-4 rounded-full flex items-center justify-center text-[9px] font-bold text-primary-foreground z-20"
              ...
              <span
                className={`text-[9px] font-body relative z-10 transition-colors ${
