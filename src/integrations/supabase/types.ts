  ...
  public: {
    Tables: {
      ...
      crushes: {
        ...
        Relationships: [
          {
            foreignKeyName: "crushes_receiver_id_fkey"
            columns: ["receiver_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "crushes_sender_id_fkey"
            columns: ["sender_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      re_swipe_admirer: {
        Args: { p_admirer_id: string; p_direction: string; p_user_id: string }
        Returns: boolean
      }
      resolve_crush_match: {
        Args: { p_crush_id: string; p_user_id: string }
        Returns: boolean
      }
    }
    Enums: {
